      ...
      <div>
        ...
        <div className="container pt-2 pb-5 border">
      		<div className="p-1">
                ...
                <p>Thank you for choosing to be part of our community at emiga.tech (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at emin@emiga.tech.</p>

                <p>When you visit our website <a href="https://emiga.tech">emiga.tech</a>, mobile application, Facebook application, and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy policy, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our Sites or Apps and our services.</p>

                <p>This privacy policy applies to all information collected through our website (such as <a href="https://emiga.tech">emiga.tech</a>), mobile application, Facebook application, (&quot;Apps&quot;), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy as the &quot;Services&quot;).</p>
                ...
                <p> Personal information you disclose to us In Short: We collect personal information that you provide to us such as name, address, contact information, passwords and security data, payment information, and social media login data.</p>

                <p>We collect personal information that you voluntarily provide to us when expressing an interest in obtaining information about us or our products and services, when participating in activities on the Services or Apps or otherwise contacting us.</p>
                ...
                <p>Publicly Available Personal Information. We collect first name, maiden name, last name, and nickname; ID; email addresses; and other similar data.</p>

                <p>Personal Information Provided by You. We collect data collected from surveys; and other similar data.</p>

                <p>Credentials. We may collect passwords, password hints, and similar security information used for authentication and account access.</p>
                ...
                <p>In Short: Some information &mdash; such as IP address and/or browser and device characteristics &mdash; is collected automatically when you visit our Services or Apps.</p>
                ...
                <p>Online Identifiers. We collect devices; device's geolocation; and other similar data.</p>

                <p> Information collected through our Apps</p>

                <p>In Short: We may collect information regarding your geo-location, mobile device, push notifications, and Facebook permissions when you use our apps.</p>

                <p>If you use our Apps, we may also collect the following information: Geo-Location Information. We may request access or permission to and track location-based information from your mobile device, either continuously or while you are using our mobile application, to provide location-based services. If you wish to change our access or permissions, you may do so in your device's settings.</p>

                <p>Mobile Device Access. We may request access or permission to certain features from your mobile device, including your mobile device's storage, and other features. If you wish to change our access or permissions, you may do so in your device's settings.</p>
                ...
                <p>We may process or share data based on the following legal basis: Consent: We may process your data if you have given us specific consent to use your personal information in a specific purpose.</p>
                ...
                <p>In Short: We only share information with the following third parties.   We only share and disclose your information with the following third parties. We have categorized each party so that you may be easily understand the purpose of our data collection and processing practices. If we have processed your data based on your consent and you wish to revoke your consent, please contact us. Advertising, Direct Marketing, and Lead Generation Google AdSense and Bing Ads Allow Users to Connect to their Third-Party Accounts Google account and Facebook account Cloud Computing Services Google Cloud Platform Content Optimization Google Site Search Data Backup and Security Google Drive Backup Functionality and Infrastructure Optimization Netlify User Account Registration and Authentication Facebook Login, GitHub OAuth, Google OAuth 2.0 and Google Sign-In Web and Mobile Analytics Google Analytics and Facebook Analytics Website Testing Google Play Console, Google Website Optimizer and Firebase Remote Config</p>
                ...
                <p>A privacy breach occurs when there is unauthorized access to or collection, use, disclosure or disposal of personal information. You will be notified about data breaches when emiga.tech believes you are likely to be at risk or serious harm. For example, a data breach may be likely to result in serious financial harm or harm to your mental or physical well-being. In the event that emiga.tech becomes aware of a security breach which has resulted or may result in unauthorized access, use or disclosure of personal information emiga.tech will promptly investigate the matter and notify the applicable Supervisory Authority not later than 72 hours after having become aware of it, unless the personal data breach is unlikely to result in a risk to the rights and freedoms of natural persons.</p>
                ...
                <p>If you have questions or comments about this policy, you may email us at emin@emiga.tech or by post to:</p>

                <p>emiga.tech  Baku AZ 1000 Azerbaijan</p>
          </div>
        </div>
      </div>
    );
