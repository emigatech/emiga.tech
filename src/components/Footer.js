...
class Footer extends Component {
    render() {
      ...
      return (
        <div className="footer border w-100 shadow-sm fixed-bottom">
      					...
      					<div>
      						<ul className="nav justify-content-end">
      						  <li className="nav-item">
      						    <a className="nav-link text-muted" href="https://www.facebook.com/emiga.mohammadi"  rel="noopener noreferrer" target="_blank">
      						  ...
      						  <li className="nav-item">
      						    <a className="nav-link text-muted" href="https://instagram.com/emiga.tech"  rel="noopener noreferrer" target="_blank">
      						  ...
      						  <li className="nav-item">
      						    <a className="nav-link text-muted" href="https://twitter.com/3mig4"  rel="noopener noreferrer" target="_blank">
